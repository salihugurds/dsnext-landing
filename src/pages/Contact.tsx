        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-600 mb-8">
              ...
              quote, or want to discuss a specific project, our team is ready to
              help.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    FENERBAHÇE MAH. <br /> HACI MEHMETEFENDİ SK. <br /> DALYAN
                    SİTESİ B NO: 24/2 İÇ KAPI NO: 3
                    <br />
                    KADIKÖY - İSTANBUL
                  </p>
                </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+90 532 393 8512</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@dsnext.com</p>
                </div>
              </div>
            </div>
